...
def construtor_da_pergunta(situação):
...
def build_prompt_beginner(situação):
    pergunta = f""""

    Você é um coach de jogos habilidoso e extremamente experiente

    Analise a seguinte situação de um jogador que não sabe nada de jogos e entrou nele pela primeira vez na vida, sem conhecimento das mecanicas, termos e objetivos do jogo.De:
...
#                               atual do jogador
situação = input("Descreva sua situação atual do jogo: ")
dica = pega_dica(situação)
print(dica)